...
| isPartOf | [Entity](#entity) &#124; [IRI](#iriDef) | A related [Entity](#entity) that includes or incorporates this [Rubric](#rubric)as a part of its whole.  The `isPartOf` value MUST be expressed either as an object or as a string corresponding to the associated entity's [IRI](#iriDef). | Optional |
...
A Caliper [RubricItem](#rubricItem) represents a single test question.
